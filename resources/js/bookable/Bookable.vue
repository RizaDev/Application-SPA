<template>
    <div class="row">
        ...
        <div class="col-md-4 pb-4">
            ...
            <div class="mt-4 text-muted warning" v-if="inBasketAlready">Seems like you've added this object to basket already. If you want to change dates, remove from the basket first.</div>
